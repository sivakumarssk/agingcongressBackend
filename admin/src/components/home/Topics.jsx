...
function Topics() {
    ...
    const handleAddTopic = async (listName) => {
        ...
        try {
            ...
            const response = await axios.patch("https://admin.agingcongress.org/api/topics", updatedTopics, {
    ...
    const handleDeleteTopic = async (listName, topic) => {
        try {
            const response = await axios.delete(`https://admin.agingcongress.org/api/topics/${listName}/${topic}`);
