...
const Accommodations = () => {
  ...
  const fetchAccommodations = async () => {
    try {
      const response = await axios.get('https://admin.agingcongress.org/api/getAccommodations');
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        ...
        await axios.put(`https://admin.agingcongress.org/api/updateAccommodation/${editingId}`, formData);
        setSuccess('Accommodation updated successfully');
      } else {
        // Add new accommodation
        await axios.post('https://admin.agingcongress.org/api/addAccommodation', formData);
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://admin.agingcongress.org/api/deleteAccommodation/${id}`);
